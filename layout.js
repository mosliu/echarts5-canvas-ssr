...
var timer = {};
var WordCloud = function WordCloud(elements, seriesModel,gridRect, options) {
    if (!isSupported) {
        return;
    }
    ...
    var getTextInfo = function getTextInfo(word, weight, rotateDeg, extraDataArray) {
        ...
        var fcanvas = createCanvas(512, 512)
...
function onWordCloudDrawn(e, seriesModel,gridRect) {
    var gridSize = seriesModel.get('gridSize');
    var item = e.item;
    if (e.drawn && seriesModel.layoutInstance.ondraw) {
        e.drawn.gx += gridRect.x / gridSize;
        e.drawn.gy += gridRect.y / gridSize;
